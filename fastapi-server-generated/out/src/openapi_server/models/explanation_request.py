...
class ExplanationRequest(BaseModel):
    ...
    session_id: StrictStr = Field(description="keeps track of the users current session")
    ...
    __properties: ClassVar[List[str]] = ["document", "session_id", "input_language", "output_language", "output_language_level", "history"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ExplanationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ExplanationRequest from a dict"""
        if obj is None:
            return None
